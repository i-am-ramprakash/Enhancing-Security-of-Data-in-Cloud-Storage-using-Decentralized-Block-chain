...
<%@page import="com.dao.Encryption"%>
...
<body class="host_version"> 
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a class="active" href="DataUserHome.jsp">Home</a></li>
						<li><a href="SearchFile.jsp" class="active">Search File</a></li>
						<li><a href="Response.jsp" class="active">View Response</a></li>	
	...
	<div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">Cloud   &nbsp;<strong>Files</strong></h2>
			...
			DBConnection.addActivity((String)request.getSession().getAttribute("email"), "Searched for files", new Date().toLocaleString());
			ResultSet r=DBConnection.getAllFiles();
			while(r.next())
			{
				int i=0;
				String hash=Encryption.decrypt(r.getString("hash"));
				StringTokenizer st=new StringTokenizer(content," ,");
				while(st.hasMoreTokens())
				{
					if(DBConnection.getFileContent(hash).contains(st.nextToken()))
					{
						i++;
					}
				}
				if(i>0)
				{
					...
					%>
												<tr style="color: black;">	
													...
													<td><%= DBConnection.getFileContent(hash) %></td>
													<td><a href="ViewData?fid=<%= r.getString("fid") %>&&key=<%= r.getString("filekey") %>">FileDownload</a></td>
													<td><a href="SendRequest?fid=<%= r.getString("fid") %>&&to=<%= r.getString("email") %>">Send Request</a></td>
													</tr>
					<% 
				}
