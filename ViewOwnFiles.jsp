            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a class="active" href="DataOwnerHome.jsp">Home</a></li>
						<li><a href="UploadFile.jsp" class="active">Upload File</a></li>
						<li><a href="ViewOwnFiles.jsp" class="active">View Own Files</a></li>
						<li><a href="Request.jsp" class="active">View Requests</a></li>
						<li><a href="SendKey.jsp" class="active">Send Key</a></li>		
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">View <strong>Files</strong></h2>
									 <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
											...
											ResultSet r=DBConnection.getMyFiles(email);
			while(r.next())
			{
					 %>
										 		<tr style="color: black;">
													...
													<td><%= r.getString("filekey") %></td>
													<td><a href="ViewData?fid=<%= r.getString("fid") %>&&key=<%= r.getString("filekey") %>">View File</a></td>
												    <td><a href="DeleteFile?fid=<%= r.getString("email") %>">Delete</a></td>
												</tr>
					 <%
				}
											%>
