						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">Trace<strong> Data </strong></h2>
								<form action="TrackDataResult.jsp" class="form-horizontal">
								<div class="form-group">
								<div class="col-sm-4">
									<input class="form-control" id="email" placeholder="Enter Pre-Hash Value" name="prehash" type="text">
									<input class="form-control" id="email" placeholder="Enter Curr-Hash Value" name="currhash" type="text">
								</div>
								</div>
							    <!-- <div class="form-group">
								<div class="col-sm-4">
									<input class="form-control" id="email" placeholder="Enter Pre-Hash Value" name="prehash" type="text">
									<input class="form-control" id="email" placeholder="Enter Curr-Hash Value" name="hash" type="text">
								</div>
								</div>
								<div class="form-group">
								<div class="col-sm-4">
							...
							<div class="row">							
								<div class="col-sm-4">
									<input type="submit" class="btn btn-light btn-radius btn-brd grd1" value="Track Data"/>
								</div>
							</div>
							</form>
							</div>
