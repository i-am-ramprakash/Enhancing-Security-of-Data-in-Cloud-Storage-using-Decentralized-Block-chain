				...
				<div id="home" class="first-section" style="background-image:url('uploads/slider-01.jpg');">
					<div class="container">
						<div class="row">
							...
							<br>		<h2 data-animation="animated zoomInRight">Data Owner &nbsp;<strong>Registration</strong></h2>
									<div class="tab-pane" id="Registration">
							<form  action="OwnerReg" method="post" class="form-horizontal">
							<div class="form-group">
								<div class="col-sm-4">
									<input class="form-control" id="email" placeholder="Name" name="name" type="text">
								</div>
								</div>
								<div class="form-group">
								<div class="col-sm-4">
								...
								<div class="form-group">
								<div class="col-sm-4">
									<input class="form-control" id="email" placeholder="Age" name="age" type="text">
								</div>
								</div>
								<div class="form-group">
								<div class="col-sm-4">
							...
							<div class="row">							
								<div class="col-sm-4">
									<input type="submit" class="btn btn-light btn-radius btn-brd grd1" value="Save &amp; Continue"/>
								<input type="reset" class="btn btn-light btn-radius btn-brd grd1" value="Reset"/>
								</div>
							</div>
							</form>
						</div><br><br>
