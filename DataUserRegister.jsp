...
<head>
    ...
    <title>Register Data User — Secure Cloud Storage</title>
    ...
    <main>
        <section class="card narrow">
            <div class="auth-banner-header" style="background-image: url('images/security_banner.png');">
                <h2 class="auth-banner-title">🔑 Register Data User</h2>
            </div>

            <p class="muted" style="margin-top: -0.5rem; margin-bottom: 1.25rem;">Create a Data User account to search shared files and request access permissions.</p>
            ...
            <form action="UserReg" method="post">
                ...
                <label>Full Name
                    <input type="text" name="name" maxlength="100" placeholder="e.g. Alex Smith" required>
                </label>
                ...
                <label>Age
                    <input type="number" name="age" min="13" max="120" placeholder="e.g. 24" required>
                </label>
            ...
            <p style="text-align: center; margin-top: 1.5rem; margin-bottom: 0;">
                Already have an account? <a href="DataUserLogin.jsp"><strong>Sign in here</strong></a>
            </p>
        </section>
    </main>
</body>
