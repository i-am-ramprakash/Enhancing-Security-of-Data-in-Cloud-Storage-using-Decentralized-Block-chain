						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">Search&nbsp;<strong>&nbsp;Files In&nbsp;</strong>Cloud</h2>
								<br>	<div class="tab-pane" id="Registration">
							<form  action="SearchResult.jsp"  class="form-horizontal">
							<div class="form-group">
								<div class="col-sm-4">
									<input class="form-control" id="email" placeholder="Search content" name="content" type="text">
								</div>
								</div>
							<div class="row">							
								<div class="col-sm-4">
									<input type="submit" class="btn btn-light btn-radius btn-brd grd1" value="Search"/>
								</div>
							</div>
							</form>
									</div>
