				...
				<div id="home" class="first-section" style="background-image:url('uploads/slider-01.jpg');">
					<div class="container">
						<div class="row">
							...
							<!-- <ul>	
							<li> -->
							<textarea name="content" id="content" placeholder="Enter File Description" style="width: 250px;"></textarea>
							<!-- </li>
							</ul> -->
							</div>
								...
								<!-- <ul>
								<li> -->
								<input type="file" name="file" id="file" value="" placeholder="Choose file..." />
								<!-- </li>
								</ul> -->
								</div>
								</div>
								...
								<div class="row">	
								<div class="col-sm-2">
								<input type="submit"  value="Upload &amp; Continue" class="btn btn-light btn-radius btn-brd grd1"  />
								</div>
								</div>
							</form>
								</div>
