            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="Admin.jsp">Cloud Storage</a></li>
                        <li><a href="DataOwnerLogin.jsp">Data Owner</a></li>
                        <li><a href="DataUserLogin.jsp">Data User</a></li>
                        <li><a href="DataOwnerRegister.jsp">Owner Registration</a></li>
                        <li><a href="DataUserRegister.jsp">User Registration</a></li>
                    </ul>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">Decentralised<strong> Cloud </strong>Login</h2>
							<br>		<div class="tab-pane" id="Registration">
							<form  action="Admin" method="post" class="form-horizontal">
							<div class="form-group">
								<div class="col-sm-4">
									<input class="form-control" id="email" placeholder="Cloud Name" name="email" type="text">
								</div>
								</div>
							<div class="form-group">
								<div class="col-sm-4">
									<input class="form-control" id="password" placeholder="Cloud Password" name="password" type="password">
								</div>
							</div>
							<div class="row">							
								<div class="col-sm-4">
									<input type="submit" class="btn btn-light btn-radius btn-brd grd1" value="Login"/>
								</div>
							</div>
							</form>
						</div>
							<br><br>		 <a data-scroll href="#pricing" class="btn btn-light btn-radius btn-brd effect-1 slide-btn" data-animation="animated fadeInLeft">View Plans</a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
