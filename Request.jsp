...
<body class="host_version"> 
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								...
								<h2 data-animation="animated zoomInRight">File &nbsp;<strong>Requests</strong></h2>
	...
	<%
			...
			ResultSet r=DBConnection.getAllRequest(owner);
			while(r.next())
			{
					...
					%>
												<tr style="color: black;">	
													...
													<td><a href="Approve?fid=<%= r.getString("fid") %>&&rid=<%= r.getString("rid") %>">Approve</a></td>
													</tr>
					<% 
