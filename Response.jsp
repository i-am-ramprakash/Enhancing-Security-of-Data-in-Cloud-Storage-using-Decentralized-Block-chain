						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">Requested <strong>Cloud </strong>Files</h2>
									<br>
									 <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
											...
											ResultSet r=DBConnection.getMyRequestedFiles(email);
			while(r.next())
			{
					 %>
										 		<tr style="color: black;">
										 			<td><%= r.getString("from") %></td>
													<td><%= r.getString("to1") %></td>
													<td><%= r.getString("fid") %></td>
													<td><%= r.getString("filekey") %></td>
													<td><a href="ViewData?fid=<%= r.getString("fid") %>&&key=<%= r.getString("filekey") %>">EncryptedFileDownload</a></td>
													<td><a href="ViewData1?fid=<%= r.getString("fid") %>&&key=<%= r.getString("filekey") %>">Download</a></td>
												</tr>
					 <%
				}
											%>
