					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								...
								<h2 data-animation="animated zoomInRight">Send &nbsp;<strong>Key</strong></h2>
								 <table class="w3-table w3-blue" style="width:1150px;text-align: center;font-size: 16px;" border="1">
											...
											ResultSet r=DBConnection.getApprovedRequests(email);
			while(r.next())
			{
					 %>
										 		<tr style="color: black;">	
													...
													<td><%= r.getString("Requests") %></td>
												    <td><a href="SendKey?fid=<%= r.getString("fid") %>&&to=<%= r.getString("from") %>">Send Key</a></td>
												</tr>
					 <%
				}
											%>
