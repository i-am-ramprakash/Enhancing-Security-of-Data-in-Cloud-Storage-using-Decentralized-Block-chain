						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">Traced Data&nbsp;<strong>in </strong>Peers</h2>
									<table class="w3-table w3-blue" style="width:1150px;text-align:center;font-size: 16px;" border="1">
											<thead> 
													<tr style="color: black;">
													<th style="text-align: center;">Data In Peer </th>
													<th style="text-align: center;">Data Stored Date</th>
												</tr>
											</thead>
											<tbody>
																				<%
			String content=request.getParameter("prehash");
			String content1=request.getParameter("currhash");																	
			ResultSet r=DBConnection.getAllHash(content,content1);
			while(r.next())
			{
					%>
												<tr style="color: black;">	
											<%-- 	<td><%= DBConnection.getFileContent1(content,content1) %></td> --%>
